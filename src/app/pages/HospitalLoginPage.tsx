      ...
      <div className="max-w-5xl w-full grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-white space-y-8 hidden lg:block">
          ...
          <div className="space-y-3">
            ...
            <InfoItem icon={<CheckCircle2 className="w-4 h-4" />} title="Assessment Terstruktur" description="Isi data RSBK, Clinical Audit, dan Patient Report per spesialisasi" />
          </div>
