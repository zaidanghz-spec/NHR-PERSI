...
const defaultNews: NewsItem[] = [
  {
    ...
    excerpt: "Platform SIAP PERSI resmi diluncurkan sebagai standar penilaian kualitas rumah sakit di Indonesia menggunakan metodologi berbasis evidence.",
    content: "Perhimpunan Rumah Sakit Seluruh Indonesia (PERSI) resmi meluncurkan platform ranking rumah sakit nasional yang menggunakan sistem penilaian SIAP PERSI (Sistem Informasi Akreditasi dan Penilaian PERSI). Platform ini dirancang untuk memberikan transparansi kualitas layanan rumah sakit kepada masyarakat Indonesia.\n\nSistem penilaian berbasis tiga pilar utama: RSBK (Rumah Sakit Berstandar Kemampuan), Clinical Audit, dan Patient Report yang mencakup PREM dan PROM. Setiap rumah sakit yang berpartisipasi akan dinilai secara komprehensif oleh tim reviewer PERSI.\n\nDr. Kuntjoro Adi Purjanto, Ketua Umum PERSI, menyatakan bahwa platform ini merupakan langkah maju dalam meningkatkan akuntabilitas dan transparansi layanan kesehatan di Indonesia.",
    category: "berita",
  ...
  },
  {
    ...
    content: "PERSI memperkenalkan metode clinical audit sebagai komponen utama dalam sistem penilaian SIAP PERSI. Metode ini menggunakan sampel 30 rekam medis per spesialisasi untuk mengevaluasi kepatuhan rumah sakit terhadap protokol klinis yang telah ditetapkan.",
    category: "publikasi",
  ...
  },
  {
    ...
    content: "Dalam upaya meningkatkan pendekatan patient-centered care, PERSI mengintegrasikan PREM (Patient Reported Experience Measures) dan PROM (Patient Reported Outcome Measures) sebagai salah satu pilar penilaian dalam SIAP PERSI Assessment.",
    category: "inovasi",
...
const defaultEvents: EventItem[] = [
  ...
  {
    id: "event-2",
    title: "Workshop SIAP PERSI Assessment untuk Rumah Sakit",
    description: "Pelatihan teknis cara mengisi dan mempersiapkan data untuk SIAP PERSI Assessment. Terbuka untuk semua rumah sakit anggota PERSI.",
    date: "2026-04-15",
  ...
  },
  {
    ...
    description: "Panduan praktis melaksanakan clinical audit yang efektif dan efisien, termasuk cara mengumpulkan dan menganalisis 30 rekam medis sesuai standar SIAP PERSI.",
    date: "2026-04-28",
    location: "Online (Zoom Webinar)",
    type: "webinar",
    imageUrl: "https://images.unsplash.com/photo-1758691462848-ba1e929da259?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGhjYXJlJTIwdGVjaG5vbG9neSUyMGRpZ2l0YWwlMjBpbm5vdmF0aW9ufGVufDF8fHx8MTc3MzM2NjU2MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
